...
public class VehicleAssignServiceTest {
	...
	public void setUp() {
		...
		vehicleAssignService = new VehicleAssignService(vehicleAssignRepository, vehicleRepository, driverRepository);
	}
	...
	public void testCreateVehicleAssign_Success() {
		...
		try (MockedStatic<VehicleAssignMapper> mapperMock = Mockito.mockStatic(VehicleAssignMapper.class)) {
			mapperMock.when(() -> VehicleAssignMapper.toEntity(dto, vehicle, driver)).thenReturn(assignEntity);
